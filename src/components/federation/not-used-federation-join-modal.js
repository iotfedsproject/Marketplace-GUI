...
class FederationJoinModal extends Component {
    ...
    onSubmit = (props) => {
        ...
        const invitationRequest = new InvitationRequest(
            this.props.federationInviteModal.federationId,//TODO change federationInvateModal
            ...
            federation ?
                <Fragment>
                    <Modal.Header closeButton>
                        <Modal.Title>Join to federation with id
                    ...
                    <form onSubmit={handleSubmit(this.onSubmit)}>
                        ...
                        <Modal.Footer>
                            <Button type="submit" bsStyle="info">Join</Button>
    ...
    render() {
        const federationIdToInvite = this.props.federationInviteModal.federationId;{/*TODO change federationInvateModal */}
...
function mapStateToProps(state) {
    return {
        ...
        federationInviteModal: state.federationInviteModal //TODO change federationInvateModal */}
    };
}
...
export default reduxForm({
    ...
    connect(mapStateToProps, {
        ...
        dismissAlert
    })(withRouter(FederationJoinModal))
);