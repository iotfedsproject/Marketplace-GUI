...
const renderBgovField = ({ input, type, placeholder, componentClass, rows,
...
export const renderBgov = ({ fields, componentClass, maxLength, label, placeholder, helpMessage, errorField, isActive }) => {
