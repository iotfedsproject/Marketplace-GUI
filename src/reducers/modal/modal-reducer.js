...
export const RESEND_VERIFICATION_EMAIL_MODAL = "RESEND_VERIFICATION_EMAIL_MODAL";
...
export const MAPPING_REGISTRATION_MODAL = "MAPPING_REGISTRATION_MODAL";
export const FEDERATION_REGISTRATION_MODAL = "FEDERATION_REGISTRATION_MODAL";
export const FEDERATION_CHANGE_RULES_MODAL = "FEDERATION_CHANGE_RULES_MODAL";
...
const INITIAL_STATE = {
    ...
    [RESEND_VERIFICATION_EMAIL_MODAL]: false,
    ...
    [MAPPING_REGISTRATION_MODAL] : false,
    [FEDERATION_REGISTRATION_MODAL] : false,
    [FEDERATION_CHANGE_RULES_MODAL] : false
};
