...
return (
    <Fragment>
    <div className="tc bg-white dib br3 pa3 ma2 grow bw2 shadow-5" style={{backgroundColor:props.backgroundColor,borderRadius: props.borderSize,border: '2px solid #27ae60', width: "700px", height: "110px"}}>
    	{/*<img className="br-100 h4 w4 dib"   src={process.env.PUBLIC_URL + imagePath} />*/}
    	  ...
    	  <h5 style={{color: "#000000",marginTop:"-4px",textAlign:"left"}}><strong>User: </strong> {props.user}</h5>
    	  <h5 style={{color: "#000000",marginTop:"-4px",textAlign:"left"}}><strong>Date Accessed:</strong> {props.dateAccessed}</h5>
