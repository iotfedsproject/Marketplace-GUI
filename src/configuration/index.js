...
export const ROOT_URL = "/marketplace";
export const USER_CPANEL_URL = "/marketplace/user/cpanel";
export const ADMIN_CPANEL_URL = "/marketplace/admin/cpanel";
export const RESET_PASSWORD_URL = "/marketplace/password_reset";
export const RESEND_VERIFICATION_EMAIL_URL = "/marketplace/resend_verification_email";

export const EXCHANGE_ROOT_URL = "/marketplace/exchange";
...
export const SUPPORTED_ONTOLOGIES = [
    {
        label : "Smart Environment",
        value : "smart_environment"
    },
    {
         label : "Smart City",
         value : "smart_city"
